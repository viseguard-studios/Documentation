...
\newenvironment{naplo}
{
    \begin{longtable}{|l|l|p{2.5cm}|p{7.5cm}|}
    \hline
...
\newenvironment{class-template-responsibility}
{
...
\newenvironment{class-template-method}
{
    \hspace*{0.4em} $\blacksquare $ \large Metódusok \normalsize
    \begin{itemize}
}
...
\newenvironment{class-template-attribute}
{
    \hspace*{0.4em} $\blacksquare $ \large Attribútumok \normalsize
    \begin{itemize}
}
...
\newenvironment{terv_v2}{	
    \begin{longtable}{| l | p{10cm} | l |}
        \hline
        \hline
        \textbf{Határidő} & \textbf{Feladat} & \textbf{Felelős} \\ \hline 
        \endhead     
