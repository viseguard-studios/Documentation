...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=0.7\textwidth]{docs/bead07/Diagrams/Inventory/InsertItemtoInfinite} 
    \caption{} 
\end{figure} 

\begin{figure}[H] 
    \centering 
    \includegraphics[width=0.7\textwidth]{docs/bead07/Diagrams/Inventory/InsertItemtoSSinventory} 
    \caption{} 
\end{figure} 
