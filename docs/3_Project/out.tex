...
\classitem{\#MakeResult(inv:Inventory, a:Asteroid)}{Létrehozza a kívánt terméket a receptből.}
\end{class-template-method}
...
\classitem{+SolarFlare()}{Örökölt függvény. Napvihar esetén hívódik meg.}
\end{class-template-method}
