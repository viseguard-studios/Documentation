...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=1\textwidth]{docs/Skeleton/diagrams/Craft_space_station/sequence/2.Possible_to_craft_station.eps} 
...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=1\textwidth]{docs/Skeleton/diagrams/Craft_space_station/sequence/3.Craft_station.eps} 
...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=1\textwidth]{docs/Skeleton/diagrams/Craft_space_station/sequence/5.Not_possible_to_craft_station.eps} 
    \caption{Ellenőrzi a készítéshez szükséges nyersanyagok meglétét a telepesnél, illetve aszteroidán, azonban legalább 1 item esetén ez nem teljesül, így a recept nem készíthető el.  } 
\end{figure} 
...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=0.7\textwidth]{docs/Skeleton/diagrams/Mine/Ship_mine1.eps} 
    \caption{} 
\end{figure} 

\begin{figure}[H] 
    \centering 
    \includegraphics[width=0.7\textwidth]{docs/Skeleton/diagrams/Mine/Ship_mine2.eps} 
    \caption{} 
\end{figure} 

\begin{figure}[H] 
    \centering 
    \includegraphics[width=0.7\textwidth]{docs/Skeleton/diagrams/Mine/Ship_mine3.eps} 
    \caption{} 
\end{figure} 
...
\begin{figure}[H] 
    \centering 
    \includegraphics[width=1\textwidth]{docs/Skeleton/diagrams/Place-Resource/placeResource4.eps} 
    \caption{} 
\end{figure} 

\begin{figure}[H] 
    \centering 
    \includegraphics[width=1\textwidth]{docs/Skeleton/diagrams/Place-Resource/placeResource5.eps} 
    \caption{} 
\end{figure} 
