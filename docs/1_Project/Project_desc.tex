...
\begin{szotar}
	...
	\szotaritem{Kéreg }{A köpeny szinonimája.}
	...
	\szotaritem{Nap }{A játékban szereplő aszteroidamező központi csillaga, ettől távolodnak és ehhez közelednek az aszteroidák az idő múlásával. Az aktuális földrajzi helyzete meghatározza az aszteroidák napközeli tulajdonságát.}
	\szotaritem{Napközeli }{Az aszteroidák változó tulajdonsága. A Naptól való bizonyos távolságon belül elhelyezkedő aszteroidákat hívjuk így.}
...
\begin{naplo}
	...
	\naplotag{2021.02.18. 14:00 }{ 5 óra }{ Dömötör Péter }
	{ 
	...
	\naplotag{2021.02.21. 17:00 }{ 1 óra }{ Dömötör Péter }
	{ 
...
\begin{toappendix}
	...
	\markdownInput[shiftHeadings=2]{\filePath[docs/meetings/meeting-3.md]}
