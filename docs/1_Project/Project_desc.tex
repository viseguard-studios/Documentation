...
\begin{funkovetelmeny}
	...
	{Mine, Control robots}
	{Bemutatás}
	{Amennyiben napközelben egy olyan radioaktív aszteroida van, aminek a kérge teljesen át lett fúrva, akkor a mag felhevül és felrobban az aszteroidával együtt. Az aszteridán lévő telepesek meghalnak, a robotok szomszédos aszteroidákra kerülnek.}
...
\begin{funkovetelmeny}
	...
	{Control robot}
	{Bemutatás, Kiértékelés}
	{Napkitörés esetén a robotok minden parancsot figyelmen kívűl hagyva megpróbálnak elbújni a legközelebbi alkalmas aszteroidában.}
...
\begin{funkovetelmeny}
	...
	{-}
	{Bemutatás, Kiértékelés}
	{A játék indításakor a rendszer létrehoz egy aszteroida mezőt és elhelyezi rajta a telepeseket.}
\end{funkovetelmeny}
...
\begin{kovetelmeny}
	...
	A kész programnak a lehető legkevesebb file-ból kell állnia hogy a használatát ezel is segytsük.
\end{kovetelmeny}
...
\begin{kovetelmeny}
    ...
    {Csapat} %Forrás
    {Bemutatás} %Ellenőrzés
    {A felhasználónak minimális előzetes imeretre legyen szüksége a program használatához.} %Leírás
	A program felhasználásához a lehető leglevesebb előzetes ismeretre legyen szükség. Ezzel is minnél több ember számára hozzáférhetővé téve.
\end{kovetelmeny}
...
\begin{kovetelmeny}
	...
	A program a felhsználását segytő hobaüzeneteket ad vissza.
\end{kovetelmeny}
...
\begin{use-case}
	{Craft}
	{A tárgyak készítése (robot, teleport-kapu, etc.)}
	{Player}
...
\begin{use-case}
	...
	\newline
	\textbf{A.1.a} Egy bizonyos Naptól való távolságon belül az napközelinek számít.
	\newline
...
\begin{naplo}
	...
	\naplotag{2021.02.20. 15:30 }{ 2 óra }{ Csapat }
	{ 
		Értekezlet \newline 
